  ...
  return (
    <>
      <SidebarHeader className="flex items-center justify-center h-14 border-b">
        <div className={cn('flex items-center gap-2', state === 'collapsed' && !isMobile && 'justify-center')}>
          <Image src="/assets/images/mandobak-logo-n.png" alt="Mandobak" width={200} height={150} className="rounded" />
          {/* <h2
            className={cn(
          ...
          >
            <span className="text-[#5B0F3A]">Mando</span>
            <span className="text-[#A8308C]">bak</span>
          </h2> */}
        </div>
      </SidebarHeader>
      <ScrollArea>
          ...
          <SidebarGroup>
            <SidebarMenu>
              <SidebarMenuItem onClick={handleLinkClick}>
                <SidebarMenuButton
                  asChild
                  isActive={pathname.startsWith('/my-account')}
                  tooltip={t.myAccount}
                >
