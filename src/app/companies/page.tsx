...
export default function CompaniesPage() {
  ...
  const [vendorsRaw, setVendors] = useState<Vendor[]>([]);
  const vendors = useTranslatedData(vendorsRaw);
  const [filteredVendorsRaw, setFilteredVendors] = useState<Vendor[]>([]);
                ...
                <TableRow>
                  <TableCell colSpan={8} className="h-64 text-center">
                    <div className="flex flex-col items-center justify-center gap-2">
                        ...
                        <span className="text-muted-foreground text-sm font-medium animate-pulse">Loading companies...</span>
                    </div>
                  </TableCell>
                </TableRow>
