      ...
      <div className={cn("border border-input rounded-md shadow-sm bg-card flex flex-col", className)}>
        ...
        >
          ...
          <Button
            type="button" variant="ghost" size="icon" 
            onMouseDown={(e) => { e.preventDefault(); saveSelection(); }}
            onClick={() => { execCommand('justifyFull'); restoreSelectionAndFocus(); }} title="Justify" aria-pressed={isAlignJustify}
        ...
        <div
          ...
          className={cn(
              "prose prose-lg max-w-none p-3 flex-1 overflow-y-auto min-h-[200px] focus:outline-none focus:ring-1 focus:ring-ring rounded-b-md bg-background text-foreground",
